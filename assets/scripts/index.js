...
function updateVideo(direction) {
    ...
    // Use a more privacy-friendly YouTube embed URL
    videoFrame.src = `https://www.youtube-nocookie.com/embed/${video.id}?rel=0&modestbranding=1`;
...
// Call this function when you need to load the YouTube API
// loadYouTubeAPI();