...
function loadContent(newsId) {
    ...
    switch (newsId) {
        case 'news1':
            heroImage.src = './public/news/news-blog/WhatsApp Image 2024-09-03 at 04.53.49.jpeg'; // Update hero image
            content = `
            <div class="blog-item">
                <div class="blog-image-1">
                    <img src="./public/news/news-blog/WhatsApp Image 2024-09-03 at 04.53.49 (1).jpeg" alt="Blog Image 1">
                </div>
            </div>
            <div class="blog-item">
                <div class="blog-text">
            ...
            <div class="blog-item">
                <div class="blog-image-1">
                    <img src="./public/news/news-blog/WhatsApp Image 2024-09-03 at 04.54.25 (1).jpeg" alt="Blog Image 2">
                </div>
            </div>
            `;
            break;
        ...
        case 'blog3':
            ...
            case 'blog4':
                heroImage.src = './public/foundation/blog-images/WhatsApp Image 2024-09-04 at 11.15.55 AM.jpeg'; // Update hero image
                content = `
                <div class="blog-item">
                    <div class="blog-image-1">
                        <img src="./public/foundation/blog-images/WhatsApp Image 2024-09-04 at 11.19.21 AM.jpeg" alt="Blog Image 1">
                    </div>
                </div>
                <div class="blog-item">
                    <div class="blog-text">
                ...
                <div class="blog-item">
                    <div class="blog-image-1">
                        <img src="./public/foundation/blog-images/WhatsApp Image 2024-09-04 at 11.15.51 AM.jpeg" alt="Blog Image 2">
                    </div>
                </div>
                <div class="blog-item">
                    <div class="blog-image-1">
                        <img src="./public/foundation/blog-images/WhatsApp Image 2024-09-04 at 11.15.57 AM.jpeg" alt="Blog Image 1">
                    </div>
                </div>
                <div class="blog-item">
                    <div class="blog-text">
                ...
                <div class="blog-item">
                    <div class="blog-image-1">
                        <img src="./public/foundation/blog-images/WhatsApp Image 2024-09-04 at 11.19.22 AM.jpeg" alt="Blog Image 2">
                    </div>
                </div>
            ...
            <div class="blog-item">
                <div class="blog-text">
                    <h2 class="blog-title-1">New Training and Traveling Kits</h2>
                    <p class="blog-excerpt-1">In a remarkable show of compassion and community support, Soy United FC recently extended its Corporate Social Responsibility (CSR) efforts with a visit to the Mathare Mental Hospital Maximum Security Unit. This impactful visit saw the team generously donating much-needed food supplies and sanitary materials to help sustain the unit, which plays a vital role in caring for patients dealing with serious mental health challenges.</p>
                </div>
            </div>
            <div class="blog-item">
                <div class="blog-text">
                    <p class="blog-excerpt-1">The Maximum Security Unit is a unique facility, housing inmates who are not only serving jail terms but also undergoing critical mental health treatment. This visit emphasized the hospital's essential mission of providing specialized care and rehabilitation to individuals in need, giving them hope for recovery and reintegration into society.
                        </p>
                </div>
            </div>
            <div class="blog-item">
